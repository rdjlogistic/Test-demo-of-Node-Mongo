...
module.exports = function(grunt) {
  ...
  grunt.config.set('uglify', {
    dist: {
      src: ['.tmp/public/concat/front/production.js'],
      dest: '.tmp/public/min/front/production.min.js'
    },
    adminDist: {
      src: ['.tmp/public/concat/admin/admin-production.js'],
      dest: '.tmp/public/min/admin/admin-production.min.js'
    },
    options: {
      mangle: {
        reserved: [
