...
module.exports = function(grunt) {
  ...
  grunt.config.set('hash', {
    ...
    js: {
      src: '.tmp/public/min/front/*.js',
      dest: '.tmp/public/hash/front/'
    },
    css: {
      src: '.tmp/public/min/front/*.css',
      dest: '.tmp/public/hash/front/'
    },
    adminJs: {
      src: '.tmp/public/min/admin/*.js',
      dest: '.tmp/public/hash/admin/'
    },
    adminCss: {
      src: '.tmp/public/min/admin/*.css',
      dest: '.tmp/public/hash/admin/'
    }
  });
