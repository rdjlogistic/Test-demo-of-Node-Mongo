...
module.exports = function(grunt) {
  ...
  grunt.config.set('cssmin', {
    dist: {
      src: ['.tmp/public/concat/front/production.css'],
      dest: '.tmp/public/min/front/production.min.css'
    },
    adminDist: {
      src: ['.tmp/public/concat/admin/admin-production.css'],
      dest: '.tmp/public/min/admin/admin-production.min.css'
    }
  });
